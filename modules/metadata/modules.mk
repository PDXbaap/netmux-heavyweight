...
libmod_mime_magic.la: mod_mime_magic.lo
	$(MOD_LINK) mod_mime_magic.lo $(MOD_MIME_MAGIC_LDADD)
...
libmod_usertrack.la: mod_usertrack.lo
	$(MOD_LINK) mod_usertrack.lo $(MOD_USERTRACK_LDADD)
...
static =  libmod_env.la libmod_mime_magic.la libmod_expires.la libmod_headers.la libmod_usertrack.la libmod_unique_id.la libmod_setenvif.la libmod_version.la libmod_remoteip.la
shared = 
