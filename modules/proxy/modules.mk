...
libmod_proxy_uwsgi.la: mod_proxy_uwsgi.lo
	$(MOD_LINK) mod_proxy_uwsgi.lo $(MOD_PROXY_UWSGI_LDADD)
libmod_proxy_fdpass.la: mod_proxy_fdpass.lo
	$(MOD_LINK) mod_proxy_fdpass.lo $(MOD_PROXY_FDPASS_LDADD)
...
libmod_proxy_hcheck.la: mod_proxy_hcheck.lo
	$(MOD_LINK) mod_proxy_hcheck.lo $(MOD_PROXY_HCHECK_LDADD)
DISTCLEAN_TARGETS = modules.mk
static =  libmod_proxy.la libmod_proxy_connect.la libmod_proxy_ftp.la libmod_proxy_http.la libmod_proxy_fcgi.la libmod_proxy_scgi.la libmod_proxy_uwsgi.la libmod_proxy_fdpass.la libmod_proxy_wstunnel.la libmod_proxy_ajp.la libmod_proxy_balancer.la libmod_proxy_express.la libmod_proxy_hcheck.la
shared = 
