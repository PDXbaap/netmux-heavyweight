...
libmod_cache_socache.la: mod_cache_socache.lo
	$(MOD_LINK) mod_cache_socache.lo $(MOD_CACHE_SOCACHE_LDADD)
...
static =  libmod_file_cache.la libmod_cache.la libmod_cache_disk.la libmod_cache_socache.la libmod_socache_shmcb.la libmod_socache_dbm.la libmod_socache_memcache.la
shared = 
