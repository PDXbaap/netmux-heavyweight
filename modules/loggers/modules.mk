...
libmod_log_forensic.la: mod_log_forensic.lo
	$(MOD_LINK) mod_log_forensic.lo $(MOD_LOG_FORENSIC_LDADD)
libmod_logio.la: mod_logio.lo
	$(MOD_LINK) mod_logio.lo $(MOD_LOGIO_LDADD)
DISTCLEAN_TARGETS = modules.mk
static =  libmod_log_config.la libmod_log_debug.la libmod_log_forensic.la libmod_logio.la
shared = 
