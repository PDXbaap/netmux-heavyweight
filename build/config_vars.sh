...
if test -f ${DESTDIR}/home/jz/Software/chainmux/bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/home/jz/Software/chainmux/bin/apr-1-config
   APU_CONFIG=${DESTDIR}/home/jz/Software/chainmux/bin/apu-1-config
else
...
test -n "/home/jz/Software/chainmux/bin/apu-1-config" && APU_INCLUDEDIR="`${APU_CONFIG} --includedir`"

installbuilddir="/home/jz/Software/chainmux/build"
